...
namespace Common.StringUtilities
{
    ...
    public static class NumberWording
    {
        ...
        */
        ...
        public static string ToMoneyWordForCheck(double dblNumber, char chrDelimiter,
            string strCurrency1, string strCurrency2, string strConnector)
        {
            StringBuilder strMoneyWord = new StringBuilder();
            string strValue = string.Format("{0:####.#0}", dblNumber);
        ...
        public static string AmountInWordsForCheck(double dblNumber)
        {
            return NumberWording.ToMoneyWordForCheck(dblNumber, '.', " Pesos", " Centavos", " and ");
        }
    }
}
